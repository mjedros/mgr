...
void ProcessingImage::SetStructuralElementArgument(cl::Kernel &kernel)
{
   ...
   case ELLIPSE:
   {
      cl_float3 ellipseParams = (cl_float3) {
          {structuralElementParams[0], structuralElementParams[1], structuralElementParams[2]}};
   ...
   {
      cl_int2 rectParams =
          (cl_int2) {{(int)structuralElementParams[0], (int)structuralElementParams[1]}};
...
void ProcessingImage::Process(cl::Kernel &kernel, cl::Image2D &image_in, cl::Image2D &image_out)
{
